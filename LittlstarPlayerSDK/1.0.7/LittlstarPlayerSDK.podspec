Pod::Spec.new do |s|
  ...
  s.preserve_paths = 'LittlstarPlayerSDK/LittlstarPlayerSDK.framework/Cardboard/module.modulemap'
  s.pod_target_xcconfig = {'SWIFT_INCLUDE_PATHS' => '$(SRCROOT)/LittlstarPlayerSDK/LittlstarPlayerSDK.framework/Cardboard/**'}
