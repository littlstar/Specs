Pod::Spec.new do |s|
  ...
  s.public_header_files = 'LittlstarPlayerSDK/LittlstarPlayerSDK.framework/Headers/Littlstar*.h'
  s.private_header_files = 'LittlstarPlayerSDK/LittlstarPlayerSDK.framework/Headers/g*.h', 'LittlstarPlayerSDK/LittlstarPlayerSDK.framework/Headers/G*.h'
